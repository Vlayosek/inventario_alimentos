...
@endsection
@section('javascript')
    <script src="{{ url('js/modules/inventario_alimentos/cocina/producto/global.js?v=2') }}"></script>
    <script src="{{ url('js/modules/inventario_alimentos/cocina/producto/script.js?v=2') }}"></script>
    <script>
        ...
        <div class="card">
            <div class="col-md-12" style="padding:1.25rem">
                <button type="button" class="btn btn-primary btnTop btn-sm escritorio" data-toggle="modal"
                    data-target="#modal-REGISTRO-SOLICITUD" v-on:click="limpiarProducto();" data-backdrop="static"
                    data-keyboard="false">
                    <i class="fa fa-plus"></i>&nbsp;NUEVO INGRESO SOLICITUD
                </button>
            </div>
            <div class="card-body">
                <div class="table" id="tablaConsulta">
                    <table class="table table-bordered table-striped" id="dtCocinaProductos" style="width:99%!important">
                        <thead>
